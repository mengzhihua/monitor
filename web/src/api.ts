...
export const api = {
  ...
  agentConfig: () => get<{ path: string; yaml: string; writable: boolean }>('/api/v1/manage/config'),
  saveAgentConfig: (yaml: string) => send<{ path: string; yaml: string; writable: boolean }>('PUT', '/api/v1/manage/config', { yaml }),
