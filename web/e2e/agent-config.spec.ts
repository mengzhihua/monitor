...
test('admin edits the local config file and keeps invalid yaml off disk', async ({ page, request }) => {
  ...
  expect(formed.yaml).toContain('http://127.0.0.1/stub_status')
