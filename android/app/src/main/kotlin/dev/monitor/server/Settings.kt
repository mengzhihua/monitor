...
class Settings(context: Context) {
    ...
    fun toYaml(dataDir: String): String {
        ...
        |  listen: ":$port"
        |collectors:
        |  disabled: [docker, systemd, nginx, redis, cgroup, k8s_kubelet, k8s_kubeproxy, k8s_apiserver, k8s_state, nvidia, intelgpu, dcgm, ethtool, ap, logind, smbios_memory, wireguard, zfspool, lvm, nvme, smartctl, megacli, hpssa, adaptecraid, storcli, libvirt, proxmox, ebpf]
        |  modules:
        |    logs: {}
        |$stream
        |""".trimMargin()
